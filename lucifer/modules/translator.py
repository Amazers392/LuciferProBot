...
def gtts(update, context):
    ...
    try:
       tts = gTTS(reply)
       tts.save("lucifer.mp3")
       with open("lucifer.mp3", "rb") as speech:
            msg.reply_audio(speech)
    finally:
       if os.path.isfile("lucifer.mp3"):
          os.remove("lucifer.mp3")
...
• /t: As a reply to get grammar corrected text of gibberish messages
...
dispatcher.add_handler(DisableAbleCommandHandler("t", spellcheck))
