...
def set_about_me(update, context):
    ...
    if message.reply_to_message:
        ...
        if repl_user_id == context.bot.id and (user_id in SUDO_USERS or user_id in DEV_USERS):
...
def set_about_bio(update, context):
    ...
    if message.reply_to_message:
        ...
        if user_id == context.bot.id and sender_id not in SUDO_USERS and sender_id not in DEV_USERS:
