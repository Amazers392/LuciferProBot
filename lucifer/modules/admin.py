...
from lucifer.modules.helper_funcs.chat_status import bot_admin, can_promote, user_admin, can_pin
from lucifer.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from lucifer.modules.helper_funcs.admin_rights import user_can_pin, user_can_promote
...
def demote(update, context):
    ...
    if user_member.status == 'creator':
        message.reply_text("Lol you want to demote the owner of this group😂")
        return ""
