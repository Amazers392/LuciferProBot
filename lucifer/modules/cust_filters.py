...
from lucifer.modules.helper_funcs.misc import build_keyboard_parser
from lucifer.modules.helper_funcs.msg_types import get_filter_type
from lucifer.modules.helper_funcs.string_handling import split_quotes, button_markdown_parser, escape_invalid_curly_brackets, markdown_to_html
...
RMALLFILTER_HANDLER = CommandHandler("stopall", rmall_filters,  filters=Filters.group)
