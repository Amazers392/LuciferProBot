...
if is_module_loaded(FILENAME):
    ...
    def gloggable(func):
        ...
        def glog_action(update, context, *args, **kwargs):
            ...
            if result:
                ...
                if log_chat:
                    send_log(update, context, log_chat, chat.id, result)
            elif result == "":
                pass
            else:
    ...
    def send_log(bot: Bot, log_chat_id: str, orig_chat_id: str, result: str):
        ...
        try:
            context.bot.send_message(log_chat_id, result, parse_mode=ParseMode.HTML, disable_web_page_preview=True)
    ...
    def unsetlog(update, context):
        ...
        if log_channel:
            context.bot.send_message(log_channel, f"Channel has been unlinked from {chat.title}")
