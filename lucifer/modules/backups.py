...
from lucifer import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
...
def export_data(update, context):
	...
	try:
		...
		pass
	context.bot.sendDocument(current_chat_id, document=open('lucifer{}.backup'.format(chat_id), 'rb'), caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `lucifer-Backup` is specially made for notes.".format(chat.title, chat_id, tgl), timeout=360, reply_to_message_id=msg.message_id, parse_mode=ParseMode.MARKDOWN)
